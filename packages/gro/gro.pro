...
macx {
  ...
  INCLUDEPATH += ../ccl-master/ ../CellEngine/include ../cellsignals/include ../CellNutrient/include ../CellPro/include ../uint256_t-master/
...
linux {
  CONFIG(debug, debug|release) {
        LIBS += -L../ccl_Debug/ -lccl -L../CellEngine/build/linux/debug -lcellengine -L../CellNutrient/build/linux/debug -lcellnutrient -L../CellPro/build/linux/debug -lcellpro -L../cellsignals/build/linux/debug -lsignals -L../uint256_t-master/build/linux/debug -luint_256 -lrt
        PRE_TARGETDEPS += ../ccl_Debug/libccl.a
  } else {
        LIBS += -L../ccl_Release/ -lccl -L../CellEngine/build/linux/release -lcellengine -L../CellNutrient/build/linux/release -lcellnutrient -L../CellPro/build/linux/release -lcellpro -L../cellsignals/build/linux/release -lsignals -L../uint256_t-master/build/linux/release -luint_256 -lrt
        PRE_TARGETDEPS += ../ccl_Release/libccl.a
  }
  ...
  #DEPENDPATH += ../Chipmunk-5.3.5/
  INCLUDEPATH += ../ccl-master/ ../CellEngine/include/ ../CellNutrient/include/ ../cellsignals/include/ ../CellPro/include ../uint256_t-master/
...
win32 {
  CONFIG(debug, debug|release) {
        LIBS += -L../ccl_Debug/debug -lccl -L../CellEngine/build/win/debug -lcellengine -L../CellNutrient/build/win/debug -lcellnutrient -L../cellsignals/build/win/debug -lsignals -L../CellPro/build/win/debug -lcellpro -L../uint256_t-master/build/win/debug -luint_256
        PRE_TARGETDEPS += ../ccl_Debug/debug/libccl.a
  } else {
        LIBS += -L../ccl_Release/release -lccl -L../CellEngine/build/win/release -lcellengine -L../CellNutrient/build/win/release -lcellnutrient -L../cellsignals/build/win/release -lsignals -L../CellPro/build/win/release -lcellpro -L../uint256_t-master/build/win/release -luint_256
        PRE_TARGETDEPS += ../ccl_Release/release/libccl.a
  }

  INCLUDEPATH += ../ccl-master/ ../CellEngine/include/ ../CellNutrient/include/ ../cellsignals/include/ ../CellPro/include ../unit256_t-master/
