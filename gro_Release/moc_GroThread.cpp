...
void GroThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GroThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (GroThread::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GroThread::renderedImage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GroThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GroThread::stateChange)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GroThread::*)(std::string , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GroThread::message)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GroThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_GroThread.data,
    qt_meta_data_GroThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
