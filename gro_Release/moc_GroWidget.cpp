...
void GroWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GroWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (GroWidget::*)(QString , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GroWidget::messageFromGro)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GroWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_GroWidget.data,
    qt_meta_data_GroWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
